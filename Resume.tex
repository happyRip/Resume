...
\Letter ~
\href{mailto:aleksander.borowski.01@gmail.com}{\nolinkurl{aleksander.borowski.01@gmail.com}}
...
\begin{quote}
\emph{Some University of Technology,}
...
\begin{quote}
\emph{\hfill Parametric box design}
\end{quote}
...
measurements given. The templates arose are then optimally fitted onto
boards of given dimensions. This way the whole template can then be cut
on a laser cutter or cnc plotter, allowing small businesses to have
their own custom box solution. ~\\
...
\begin{quote}
\emph{\hfill Typing test in your terminal}
\end{quote}
...
\begin{quote}
\emph{\hfill My personal resume}
\end{quote}

\end{col}

The document You are seeing now was created in \emph{rMarkdown} and is
converted to a pdf format automatically using \emph{pandoc} and
\emph{GitHub Actions}. ~\\
...
\tightlist
\item
  \href{https://en.wikipedia.org/wiki/Computer-aided_design}{ComputerAided
  Design}
\item
